            ...
            <div className="relative flex flex-col items-center justify-center">
              <div className="relative">
                ...
                <img
                  ...
                  className="relative rounded-lg w-72 md:w-140 object-cover"
                />
              </div>

              {/* Arrows Group */}
              <div className="absolute right-0 md:right-[-3.5rem] top-1/2 -translate-y-1/2 flex flex-col space-y-3">
                <button
                  onClick={goBack}

...
          </h4>
          <h3 className="text-4xl md:text-5xl font-semibold mt-2 mb-2">
            Laimina<br />Methuselha
          </h3>
          {/* LinkedIn Logo for Laimina */}
          <a
            href="https://www.linkedin.com/in/laimina-m-824a89137/"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block mb-4 text-blue-700 hover:text-blue-900 transition-colors duration-200"
          >
...
          </h4>
          <h3 className="text-4xl md:text-5xl font-bold mt-2 mb-2">
            Charles<br />Methuselha
          </h3>
          {/* LinkedIn Logo for Charles */}
          <a
            href="https://www.linkedin.com/in/charles-methuselha-302ba8a5/"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block mb-4 text-blue-700 hover:text-blue-900 transition-colors duration-200"
          >

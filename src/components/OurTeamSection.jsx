  ...
  return (
    <div className="flex flex-col items-center text-center">
      <img
        src={image}
        alt={name}
        className="w-56 h-60 rounded-lg object-cover mb-3"
      />
...
const OurTeamSection = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      image: anjali,
      name: "Anushka Gupta",
      title: "BDM & Sales Lead",
      linkedin: ""
    },
    {
      image: ronit,
      name: "Ronit Singh Nayal",
      title: "Web Developer",
      linkedin: ""
    },
    {
  ...
  const ceoData = {
    ...
    image: Laiminaimg,
    shortDesc:
      "Meet Lamina Methuselha, the visionary founder and CEO behind Global Assist Inc,. a dynamic and growing organization revolutionizing outsourcing and virtual work solutions for small and mid-size firms by providing more employment opportunities and delivering innovative virtual solutions that empower business to thrive in today’s dynamic landscape.",
    fullDesc:
  ...
  const cooData = {
    ...
    image: charlesimg,
    shortDesc:
      "Introducing Charles Methuselha, the dynamic Co-Founder and Chief Operating Officer driving innovation and efficiency at Global Assist Inc. With a keen focus on creating robust SOPs, implementing protocols, and optimizing systems, Charles plays a pivotal role in ensuring the organization operates seamlessly.",
    fullDesc:
      "Introducing Charles Methuselha, the dynamic Co-Founder and Chief Operating Officer driving innovation and efficiency at Global Assist Inc. With a keen focus on creating robust SOPs, implementing protocols, and optimizing systems, Charles plays a pivotal role in ensuring the organization operates seamlessly. Boasting an impressive 25 years of multifaceted experience across diverse industries including Recruiting, Real Estate, Corporate, ITES, BPO, KPO, and Aviation, Charles brings a wealth of expertise to the table. His extensive background spans key domains such as Operations, Sales, Business Development, Training, and Administration, making him a versatile leader adept at navigating complex challenges and driving strategic growth initiatives. Beyond his professional prowess, Charles is fueled by a passion for fast cars and engineering, embodying a perfect blend of work and play. While he thrives in the fast-paced business world, he also understands the importance of family, always prioritizing quality time with loved ones.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {[{ ...ceoData, key: "ceo" }, { ...cooData, key: "coo" }].map((person) => (
            <div
              key={person.key}
              className="flex flex-col sm:flex-row items-start p-6 bg-gray-50 rounded-lg shadow-sm"
            >
              <img
                src={person.image}
                alt={person.name}
                className="w-48 h-56 sm:w-56 sm:h-64 rounded-lg object-cover mb-4 sm:mb-0 sm:mr-6"
              />
              <div>
                ...
                <button
                  ...
                  onClick={() => handleToggle(person.key)}
                >
       ...
       {/* Horizontally scrollable team carousel with arrows */}

...
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-[#333] text-white px-3 py-2 rounded-full md:px-3 md:py-2 md:block"
          >
            ←
          </button>
          <div
...
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-[#333] text-white px-3 py-2 rounded-full md:px-3 md:py-2 md:block"
          >
            →
          </button>
        </div>
...
              className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-[#333] text-white px-4 py-2 z-10 rounded-full md:block"
            >
              ←
            </button>
            <div
...
              className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-[#333] text-white px-4 py-2 z-10 rounded-full md:block"
            >
              →
            </button>
          </div>

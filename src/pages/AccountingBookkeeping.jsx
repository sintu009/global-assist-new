    ...
    <section className="py-18 mx-auto font-sans overflow-x-hidden">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-10 mb-20 md:px-20 px-6">
        ...
        <div className="flex-1 mt-[-40px] sm:mt-[-86px]">
          ...
          <h1 className="text-4xl md:text-4xl font-extrabold text-[#2F327D] mb-4 leading-snug font-[Nunito_Sans,sans-serif]">
        ...
        <div className="grid md:grid-cols-2 items-center gap-0">
          ...
          >
            <img
              src={complianceImg}
              alt="Compliance"
              className="w-[85%] h-auto mx-0 md:ml-23"
            />
          </motion.div>
          <motion.div
